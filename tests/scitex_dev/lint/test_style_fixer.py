...
class TestFixStyleKwargs:
    ...
    def test_drops_first_kwarg(self):
    ...
    def test_drops_middle_kwarg(self):
...
class TestFixStyleLineCalls:
    ...
    def test_drops_indented_tight_layout(self):
...
class TestFixFileNotebook:
    def test_fixes_notebook_in_place(self, tmp_path):
        nb = {
            "cells": [
                {
                    "cell_type": "code",
    ...
    def test_skips_clean_notebook(self, tmp_path):
        nb = {
            "cells": [
                {
                    "cell_type": "code",
