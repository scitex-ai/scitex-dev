"""Tests for the branding-translation registry helpers (STX-NM: real registry).

No mocks: we exercise the actual ``registry.yaml`` shipped with scitex-dev
and the real helpers in ``scitex_dev._branding``.
"""
