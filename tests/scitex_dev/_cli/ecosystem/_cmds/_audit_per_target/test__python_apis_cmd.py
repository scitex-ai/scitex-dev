"""Registration smoke test for `ecosystem audit-python-apis` (`_python_apis_cmd.py`).
...
def test_audit_python_apis_help_exits_zero():
    # Arrange
    runner = CliRunner()
    # Act
    result = runner.invoke(_make_group(), ["ecosystem", "audit-python-apis", "--help"])
    # Assert
