"""Registration smoke test for `ecosystem audit-django` (`_django_cmd.py`).
...
def test_audit_django_help_exits_zero():
    # Arrange
    runner = CliRunner()
    # Act
    result = runner.invoke(_make_group(), ["ecosystem", "audit-django", "--help"])
    # Assert
