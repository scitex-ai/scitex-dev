"""Registration smoke test for `ecosystem audit-mcp-tools` (`_mcp_tools_cmd.py`).
...
def test_audit_mcp_tools_help_exits_zero():
    # Arrange
    runner = CliRunner()
    # Act
    result = runner.invoke(_make_group(), ["ecosystem", "audit-mcp-tools", "--help"])
    # Assert
