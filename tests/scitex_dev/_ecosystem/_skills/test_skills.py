...
class TestFindSkillsDir:
    ...
    def test_new_layout_found(self, skills_tree):
        with patch(
            "scitex_dev._ecosystem._skills.skills.get_package_root",
...
class TestExportSkills:
    ...
    def _patch_discovery(self, pkg_root, pip_name="test-pkg", module_name="test_pkg"):
        ...
        return (
            patch(
                "scitex_dev._ecosystem._skills.skills.discover_packages",
            ...
            patch(
                "scitex_dev._ecosystem._skills.skills._get_package_version",
                return_value="1.0.0",
            ),
        )
...
class TestSkillsCLI:
    ...
    def _patch_list_skills(self):
        ...
        return patch(
            "scitex_dev._ecosystem._skills.skills.list_skills",
            return_value={
                "mock-pkg": [
                    {
                        "name": "SKILL",
