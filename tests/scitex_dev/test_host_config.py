...
from scitex_dev.host_config._declarations import AUDITD_PROCESS_KILL, JOURNALD_PERSISTENT
from scitex_dev.host_config._declarations import provide as provide_declarations
