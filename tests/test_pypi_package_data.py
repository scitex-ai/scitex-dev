...
def test_list_src_data_files_includes_md_excludes_py(tmp_path: Path) -> None:
...
def test_has_package_data_block_setuptools(tmp_path: Path) -> None:
...
def test_suggest_fix_setuptools_emits_quoted_globs() -> None:
...
def test_audit_with_explicit_wheel_clean(tmp_path: Path) -> None:
...
def test_audit_detects_missing_data_file(tmp_path: Path) -> None:
