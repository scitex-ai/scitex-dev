...
| Variable | Purpose |
|---|---|
| `SCITEX_DIR` | Single lever that relocates the user-scope root from `~/.scitex` to anywhere else. See [`01_ecosystem_06_local-state-directories.md`](01_ecosystem_06_local-state-directories.md) §6. |
