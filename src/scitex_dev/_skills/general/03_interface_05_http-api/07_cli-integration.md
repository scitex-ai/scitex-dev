...
Per the ecosystem env-var convention (`01_ecosystem_04_environment-variables.md`), HTTP-related vars use `SCITEX_<PKG>_HTTP_*`:
...
- [03_interface_02_cli/](../03_interface_02_cli/) — the noun-verb CLI convention this builds on.
- [01_ecosystem_04_environment-variables.md](../01_ecosystem_04_environment-variables.md) — env-var prefix rule.
