...
- [ ] Auto-generate a reference shape file showing the canonical `_mcp_server.py` structure (parallel to CLI's [16_example.md](../03_interface_02_cli/16_example.md)). Source: `~/proj/scitex-audio/src/scitex_audio/_mcp_server.py`.
