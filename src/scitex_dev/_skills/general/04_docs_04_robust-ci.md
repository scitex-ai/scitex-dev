...
resolves them. See [`04_docs_03_rtd.md`](04_docs_03_rtd.md) for the
RTD-side variant.
...
- [`04_docs_02_sphinx.md`](04_docs_02_sphinx.md) — Sphinx layout, the
  `_sphinx_html` wheel bundle, `audit-project` PS-12x rules.
- [`04_docs_03_rtd.md`](04_docs_03_rtd.md) — Read the Docs onboarding +
