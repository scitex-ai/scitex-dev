...
> Sibling leaves: [`./root`](02_package_01_project-structure-root.md) · [`./src`](02_package_02_project-structure-src.md) · [`./scripts/makefile`](02_package_04_project-structure-makefile.md) · [`./examples`](02_package_05_project-structure-examples.md) · [`./tests`](02_package_06_project-structure-tests.md)
...
Substantial scripts get tests under `./tests/scripts/` (mirrors `./scripts/`). See [02_package_06_project-structure-tests.md](02_package_06_project-structure-tests.md).
...
- **Move to `./examples/`** if it's a demo of a feature → numbered, with `_out/` committed, with a matching `tests/examples/test_*.py`. See [02_package_05_project-structure-examples.md](02_package_05_project-structure-examples.md).
- **Move to `./src/<pkg>/`** if it's a function the package should expose publicly → put it under `__all__`, write proper docstrings, add `tests/<pkg>/test_<name>.py`. See [02_package_02_project-structure-src.md](02_package_02_project-structure-src.md).
