...
description: The scaffold template every new SciTeX package should start from — full SKILL.md plus the standard-7 leaf set (01_installation, 02_quick-start, 03_python-api, 04_cli-reference, 05_mcp-tools, 06_http-api, 20_env-vars). Lives at `~/proj/scitex-dev/src/scitex_dev/_skills_template/<pip-name>/`; cloned by `scitex-dev skills init --package <name>`.
...
when: |
  <trigger condition>.
  <optional second sentence — multiline block literals are fine>.
how: <primary entry point — e.g., `import <import_name>` or `<pip-name> --help`>.
description: <auto-generated; DO NOT hand-edit — see 05_frontmatter-metadata.md>
tags: [scitex-<pkg>]
...
description: <auto-generated; DO NOT hand-edit>
...
topic: Python API
details: |
  Public Python API of <pip-name> — exported functions, signatures,
...
- [05_frontmatter-metadata.md](05_frontmatter-metadata.md) — frontmatter fields and auto-derived `description:`
