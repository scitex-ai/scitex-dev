...
- [ ] Sweep downstream packages so every `scitex-*` repo's `_skills/<pip-name>/SKILL.md` references this directory (not the old `03_interface_04_skills.md` monolith)

## Done

- [x] 2026-04-30 — consolidate `03_interface_04_skills.md` (monolith) + `06_skills_*.md` (six leaves) into this directory; remove section 6 from parent SKILL.md
...
- [x] 2026-04-30 — implemented `scitex-dev ecosystem audit-skills` linter: 17 rules SK101–SK704; 17 smoke tests pass; rule catalog documented in [12_quality-checklist.md](12_quality-checklist.md) §9
...
- [x] 2026-04-30 — fixed `_collect_skills_from_dir` recursion + `export_skills` to preserve nested rel_paths so `general/03_interface_04_skills/00_index.md` survives the round-trip; smoke-tested with `scitex-dev skills collect /tmp/...` exporting 113 files across 3 namespaces
