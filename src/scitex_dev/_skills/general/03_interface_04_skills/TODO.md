...
- [x] 2026-04-30 — fixed `_collect_skills_from_dir` recursion + `export_skills` to preserve nested rel_paths so `general/03_interface_04_skills/SKILL.md` survives the round-trip; smoke-tested with `scitex-dev skills collect /tmp/...` exporting 113 files across 3 namespaces
