...
- [01_ecosystem_06_local-state-directories.md](01_ecosystem_06_local-state-directories.md)
...
- [02_package_12_no-mocks.md](02_package_12_no-mocks.md) — Why
  `_crontab.read_crontab` / `_ci_watch.red_workflows_for` expose
  callable seams instead of being patched in tests.
