...
See `05_development_06_subprocess-coverage.md`.
...
See `05_development_07_demo-smoke-tests.md`.
...
`05_development_03_release-automation.md` for release mechanics.
...
- `05_development_06_subprocess-coverage.md` — step 1.
- `05_development_07_demo-smoke-tests.md` — step 2.
- `02_package_11_ci-and-codecov.md` — overall CI / codecov.yml setup.
- `02_package_08_quality.md` — the 512-LOC file budget and other
  audit rules referenced in step 5.
- `98_quality_01_failure-playbook.md` — no-cut-corners principle that
