...
### Consuming f-string paths in scripts

The usage-side detail — `eval(CONFIG.PATH.<KEY>)` rules, glob semantics, and the "phantom-unused-variable" linter footgun with its mandatory `# noqa` convention — lives in [`02_research-project_11_config-fstring-paths.md`](02_research-project_11_config-fstring-paths.md).
