#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Backward-compat shim — re-exports from `scitex_dev._cli._dispatch`.

The reusable docs/skills CLI mixins moved to `scitex_dev._cli._dispatch`
