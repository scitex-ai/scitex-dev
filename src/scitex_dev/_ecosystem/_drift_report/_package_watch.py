...
Every comparison here presumes the installed version string can be
BELIEVED. That prior question is a separate concern with a separate
answer — see ``_untrustworthy_installs``, whose finding invalidates this
module's for any package it names.
"""
...
from ..._release._install_probe import get_version_installed_verified
...
def check_critical_package_drift(
    ...
    *,
    ...
    it is surfaced by :func:`._untrustworthy_installs.check_untrustworthy_installs`,
    which is a louder and more urgent finding than being behind.
