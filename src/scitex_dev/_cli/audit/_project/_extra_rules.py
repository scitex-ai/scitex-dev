...
EXTRA_RULES: List[Tuple[str, str, str, str, str]] = [
    ...
    # directive of 2026-08-05 (relax the CI rules; take Spartan out of CI;
    ...
    (
        ...
        (
            ...
            "block — a destination no machine serves, which GitHub queues "
            "forever rather than rejecting — see PS-224."
        ),
        "W",
