...
EXTRA_RULES: List[Tuple[str, str, str, str, str]] = [
    ...
    (
        ...
        (
            ...
            "empty (see PS-214). BOTH CASES SUCCEED SILENTLY: pip does NOT "
            "reject an undeclared extra — it warns and EXITS 0 with the base "
            "package installed, and an empty extra likewise exits 0. The user "
            "sees the remedy work, hits the original failure again, and has "
            "no reason to connect them; nothing surfaces the lie. Fix the "
