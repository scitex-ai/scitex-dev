...
# 01_ecosystem_06_local-state-directories.md. Kept in sync manually with
        ...
        out.append(
            violation_cls(
                ...
                (
                    ...
                    f"_skills/general/01_ecosystem_06_local-state-directories.md "
                    f"§9.5."
                ),
            )
        )
...
def check_ps146_pip_install_side_effect(
    ...
    detail = " ; ".join(issues) + (
        ...
        "01_ecosystem_06_local-state-directories.md §3.5."
    )
        ...
        out.append(
            violation_cls(
                ...
                (
                    ...
                    f"03_interface_02_cli/03_required-introspection-commands.md "
                    f"and 01_ecosystem_06_local-state-directories.md §11."
                ),
            )
        )
