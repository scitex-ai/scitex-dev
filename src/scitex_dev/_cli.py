...
try:
    ...
    COMMAND_CATEGORIES = [
        ("Development", ["versions", "config", "fix-mismatches", "rename"]),
    ...
    @click.option("--scope", default=None, help="Search scope: api, cli, mcp, docs.")
